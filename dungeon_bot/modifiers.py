...
class KnockedDown(Modifier): #simply adds defence, hinders evasion
	...
	def __init__(self, granted_by, host, stats = {}, name="knockdown", description="Loose 5d6 evasion, 2d6 your defence, and half your dexterity.") :
...
class Vunerable(Modifier): #simply adds defence, hinders evasion
	...
	abilities_granted = []
	tags_granted = []
	def __init__(self, granted_by, host, stats = {}, name="vunerable", description="Loose 3d6 defence for a turn."):
		Modifier.__init__(self, granted_by, host,  stats, name, description )
